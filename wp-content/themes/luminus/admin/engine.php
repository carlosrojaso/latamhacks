            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    <div class="span12 margin0">
                        <div class="icon32 edenfresh-icon"></div>
                        <h2 class="thm_heading">EdenFresh Theme Options &nbsp;&nbsp;&nbsp;&nbsp;<div class="btn-group">
                <a class="btn btn-success" href="http://wpeden.com/product/luminus-pro-responsive-multipurpose-wordpress-theme/" target="_blank">Get Pro!</a> 
